      ...
      <table class="table  table-sm table-reponsive">
        <thead>
          ...
          <tr>
             ...
             <td><button class="btn-danger" style="width:100px; height:40px; padding:0; margin:0;" type="submit"><a href="delete.php?id=<?= $data['id'];?>">Delete</a></button>
             <button class="btn-danger" style="width:100px; height:40px; padding:0; margin:0;" type="submit"><a href="edit.php?id=<?= $data['id'];?>">Edit</a></button></td>
          </tr>
        <?php $no ++;} ?>
        </thead>
      </table>
